      ...
      <div className="container mx-auto h-full">
        ...
        <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <p className="max-w-[500px] mb-6 text-black/80 text-right direction-alternate">
              تاسس عام 1985 وهو أحد المعاهد التابعة لوزارة التربية والتعليم في سوريا، ويهدف إلى إعداد الكوادر الفنية المتخصصة في مجالات الصناعة. يقدم المعهد برامج تعليمية تهدف إلى تخريج تقنيين مؤهلين للعمل في القطاعات الصناعية المختلفة.</p>
